...
?>
  ...
  <h1>SEJAM BEM-VINDOS À GREENWORLD</h1>
  <P>SITE ESPECIFICO PARA INFORMAÇÕES REFERENTES AS FAZENDAS DIGITAIS</P>

   <div id="logo">
    <img src="loggo.jpeg" alt="HTML tutorial" style="width: 350px;;height: auto;">
   </div>
